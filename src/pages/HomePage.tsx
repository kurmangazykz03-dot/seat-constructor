  ...
  return (
    <div className="bg-[#FAFAFA] w-full min-h-screen flex justify-center items-center">
      <div className="bg-white w-[448px] h-[500px] rounded-[16px] drop-shadow-[0_0_15px_rgba(0,0,0,0.10)] flex items-center flex-col pt-[43px] pb-[107px] px-[48px]">
        ...
        <Link
          to="/editor"
          className="w-[352px] h-[56px] flex items-center justify-center rounded mb-[16px] text-white bg-[#525252] hover:bg-[#dc2626]"
        >
          Редактировать
        </Link>
        ...
        <Link
          to="/viewer"
          className="w-[352px] h-[56px] flex items-center justify-center rounded text-white bg-[#525252] hover:bg-[#dc2626]"
        >
          Просмотр
        </Link>
      </div>
